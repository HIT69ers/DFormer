...
C.backbone = "DNeXtV2"
C.pretrained_model = ""
C.rgb_branch = "B"  # Remember change the path below.
C.rgb_pretrained = None
...
C.output_to_depth = True  # If adding fused feature maps into depth backbone
C.stage1_scc = True  # If true, adding feature fusion after stage 1
