...
C.pretrained_model = ""
C.rgb_branch = "mit_b1"  # Remember change the path below.
C.rgb_pretrained = "/mnt/syh/pretrained/segformer/mit_b1.pth"
C.d_branch = "mit_b0"  # Remember change the path below.
C.d_pretrained = "/mnt/syh/pretrained/segformer/mit_b0.pth"
C.downsample_ratio = 0.7  # Remember change the name below.
C.downsample_name = "seven"
