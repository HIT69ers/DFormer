...
def test_DNeXtV2():
    ...
    dummy_rgb, dummy_depth = torch.randn(1, 3, 480, 640), torch.randn(1, 3, 480, 640)
    dnext = DNeXtV2(rgb_backbone="T", d_backbone="A", downsample_ratio=0.5, output_to_depth=True, drop_path_rate=0.1)
    dnext.init_weights(pretrained_rgb="/mnt/syh/pretrained/ConvNeXtV2/ImageNet-22K/convnextv2_tiny_22k_384_ema.pt",
                       pretrained_d=None)
